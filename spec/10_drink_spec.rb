...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:my_drink) { described_class.new('Beer', 16) }

      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(my_drink.type).to eql 'Beer'
      end

      # remove the 'x' before running this test
      it 'has 16 ounces' do
        expect(my_drink.ounces).to eql 16
      end
    end
  end
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      # Create an explicit subject, using 'described_class' and your choice of
      # beverage type.
      subject(:my_drink) { described_class.new('Whisky', 16) }
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_drink) { described_class.new('Whisky', 12) }
      # remove the 'x' before running this test
      it 'is not full' do
