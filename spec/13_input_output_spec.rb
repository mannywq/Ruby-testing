...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:game_end) { described_class.new(5, 4) }
      # remove the 'x' before running this test
      it 'is not game over' do
        expect(game_end).not_to be game_end.game_over?
      end
    end
  end
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        input = 'hello'
        check = game_check.verify_input(input)
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        letter_2 = 'there'
        number = '7'
        allow(game_loop).to receive(:player_input).and_return(letter_1, letter_2, number)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 2-3' do
      subject(:game) { described_class.new(3, '3', 2) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        congrats_phrase = "Congratulations! You picked the random number in #{game.count} guesses!\n"
    ...
    context 'when count is 4 and over' do
      subject(:game) { described_class.new(3, '3', 5) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        phrase = "That was hard. It took you #{game.count} guesses!\n"
